...
return [
    'name' => env("APP_NAME", "FSUU DSAC"),
    'manifest' => [
        'name' => env('APP_NAME', 'FSUU DSAC'),
        'short_name' => env("APP_NAME", "FSUUDSAC"),
        'start_url' => '/',
        'background_color' => env("MIX_APP_BG_COLOR", "#ffffff"),
        'theme_color' => env("MIX_APP_THEME_COLOR", "#000000"),
        'display' => 'standalone',
        'orientation' => 'any',
        'status_bar' => env("MIX_APP_THEME_COLOR", "black"),
        'icons' => [
            '72x72' => [
