...
export default function PageSection() {
	...
	const { mutate: mutateDeleteSection, loading: loadingDeleteSection } = DELETE(
		`api/ref_section`,
		"section_list"
	);

	const handleDelete = (record) => {
		mutateDeleteSection(record, {
			onSuccess: (res) => {
				console.log("res", res);
				if (res.success) {
									...
									return (
										<>
											...
											<Popconfirm
												...
												onCancel={() => {
													notification.error({
														message: "Section Deactivate",
														description: "Section was not deactivated",
													});
												}}
												okText="Yes"
												cancelText="No"
